...
| `make ctrl` | `Attitude`: the rotation maths, the control law, limits, yaw priority, bad input, and a closed-loop flight proving a leading heading target cannot move the thrust |
